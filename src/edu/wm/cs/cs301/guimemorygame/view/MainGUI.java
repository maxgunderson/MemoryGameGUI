...
//		createGameWonFrame();
	...
	private JLabel createCountLabel() {
		...
		if (turnCount == 1) {
			label = new JLabel("You won the game in 1 move.");
		} else {
			label = new JLabel("You won the game in " + turnCount + " moves.");
		}
		return label;
	}
